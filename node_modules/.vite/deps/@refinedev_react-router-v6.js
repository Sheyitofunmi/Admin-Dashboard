...
var F = { go: () => {
  ...
  var c;
  let e = useParams(), { pathname: t, search: r } = useLocation(), { resources: i } = (0, import_react2.useContext)(ut), { resource: s, action: n, matchedRoute: o } = import_react.default.useMemo(() => Go(t, i), [i, t]);
...
var j = (e, t) => {
  ...
  if (typeof n == "string" && t === "show") return n;
  if (typeof n == "object" && t === "show") return n.path;
...
var M = ({ children: e }) => {
  let { resources: t } = O(), r = import_react3.default.useMemo(() => N(t), [t]);
  return e ? e(r) : import_react3.default.createElement(Routes, null, r);
};
var K = ({ resource: e, meta: t }) => {
  let r = mt(), { resource: i, resources: s } = O(e), n = i || s.find((o) => o.list);
  if (n) {
...
var Y = ({ translationKey: e = "warnWhenUnsavedChanges", message: t = "Are you sure you want to leave? You have unsaved changes." }) => {
  let r = G(), { pathname: i } = useLocation(), { warnWhen: s, setWarnWhen: n } = lt();
...
function ae2({ handler: e }) {
  var p;
  let t = useLocation(), { action: r, id: i, params: s, pathname: n, resource: o } = ae(), a = G(), c = at(), f = (o == null ? void 0 : o.identifier) ?? (o == null ? void 0 : o.name), u = (o == null ? void 0 : o.label) ?? ((p = o == null ? void 0 : o.meta) == null ? void 0 : p.label) ?? c(f, r === "list" ? "plural" : "singular");
